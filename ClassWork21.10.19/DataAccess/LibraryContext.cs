...
namespace ClassWork21_10_19.DataAccess
{
	public class LibraryContext : DbContext
	{
		...
		{
			optionsBuilder.UseSqlServer("Server=A-305-04;Database=LibraryDatabase_;Trusted_Connection=true;");
		}
		...
		protected override void OnModelCreating(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<BooksStudents>().ToTable("_books_students").Property(x=>x.BookId).HasColumnName("_book_ID");
			modelBuilder.Entity<BooksStudents>().ToTable("_books_students").Property(x=>x.Student).HasColumnName("_student_ID");
